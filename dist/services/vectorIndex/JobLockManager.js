...
exports.jobLockManager = exports.JobLockManager = void 0;
class JobLockManager {
    constructor() {
        this.locks = new Map();
        this.globalLock = null;
        this.lockTimeout = 3600000; // 1 小時超時
    }
    /**
     * 取得檔案鎖定
     */
    acquireFileLock(fileId, jobId) {
        // 檢查是否已被鎖定
...
// 單例
exports.jobLockManager = new JobLockManager();
// 定期清理過期鎖定
setInterval(() => {
    exports.jobLockManager.cleanupExpiredLocks();
}, 60000); // 每分鐘清理一次
